...
| `staticData`           | `array \| object`   | Supplies static grid data instead of fetching from API. You can pass an array of rows, or `{ records, lookups, recordCount }`. When provided, Grid automatically uses client-side sorting/filtering/pagination behavior.                                                                                                                                                                                                                                                             | -                 | No           |
