...
| `pivotApi`             | `string`            | Enables the **Excel With Pivot** export option in the toolbar. Pivot export uses the same backend API/payload flow as other exports; only the export action differs.                                                                                                                                                                                                                                                                                                             | -                 | No           |
