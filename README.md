...
| `exportTemplate`       | `string`            | Deprecated. Pivot export now sends the same request payload as other exports and ignores template-specific request parameters.                                                                                                                                                                                                                                                                                                                                                     | -                 | No           |
| `configFileName`       | `string`            | Deprecated. Pivot export now sends the same request payload as other exports and ignores pivot-specific config query parameters.                                                                                                                                                                                                                                                                                                                                                   | -                 | No           |
| `pivotApi`             | `string`            | Enables the **Excel With Pivot** export option in the toolbar. Pivot export still calls the same `api`/backend endpoint and sends the same payload as other exports; only the export action differs.                                                                                                                                                                                                                                                                          | -                 | No           |
