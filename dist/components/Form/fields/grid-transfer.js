...
const _excluded = ["component", "name", "column", "field", "formik", "type", "model"];
...
const TransferField = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, column.modifiedLabel ? /*#__PURE__*/_react.default.createElement(Component, _extends({
    selected: value,
