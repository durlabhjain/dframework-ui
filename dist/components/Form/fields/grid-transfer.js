...
const _excluded = ["component", "name", "field", "formik", "type", "model", "modifiedLabel"];
...
const TransferField = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, modifiedLabel ? /*#__PURE__*/_react.default.createElement(Component, _extends({
    selected: value,
